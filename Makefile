...
OBJ_DIRS =	obj/ $(addprefix obj/, common pswap_recursion get_next_line operations pswap_recursion/operations dequeue)
...
SRCS_COM +=$(addprefix src/common/, errors.c handle_args.c is_sorted_lst.c \
		...
		utils.c)
SRCS_COM +=$(addprefix src/dequeue/, add.c create.c remove.c sort.c)
